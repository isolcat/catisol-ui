...
\r
.switch:checked::before {\r
    left: 30px;\r
    transition: 0.3s;\r
}.ctextarea textarea::-webkit-input-placeholder {\r
    /* WebKit browsers */\r
    color: #999;\r
    font-style: italic;\r
}\r
\r
.ctextarea textarea:-moz-placeholder {\r
    /* Mozilla Firefox 4 to 18 */\r
    color: #999;\r
    font-style: italic;\r
}\r
\r
.ctextarea textarea::-moz-placeholder {\r
    /* Mozilla Firefox 19+ */\r
    color: #999;\r
    font-style: italic;\r
}\r
\r
.ctextarea textarea:-ms-input-placeholder {\r
    /* Internet Explorer 10+ */\r
    color: #999;\r
    font-style: italic;\r
}\r
\r
.ctextarea textarea::placeholder {\r
    /* Modern browsers */\r
    color: #999;\r
    font-style: italic;\r
}\r
\r
.ctextarea .word-limit {\r
    margin-top: 4px;\r
    font-size: 12px;\r
    color: #999;\r
}\r
\r
.ctextarea .character-count {\r
    margin-top: 4px;\r
    font-size: 12px;\r
}.upload {\r
    position: relative;\r
...
\r
\r
.inputfile+label::after {\r
    content: '\u9009\u62E9\u4E86\u6587\u4EF6\uFF1A';\r
    margin-left: 10px;\r
}\r
\r
.inputfile+label+span {\r
    display: inline-block;\r
}`;
document.head.appendChild(__vite_style__);
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue")) : typeof define === "function" && define.amd ? define(["exports", "vue"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.CatIsolUI = {}, global.Vue));
  ...
  const CheckBox = vue.defineComponent({
    ...
    setup(props2, {
      ...
      const checkboxRef = vue.ref(false);
      const size = {
        small: {
          x: "2",
          y: "1",
  ...
  const Avatar = vue.defineComponent({
    ...
    setup(props2) {
      ...
      return () => vue.createVNode("div", null, [vue.createVNode("img", {
        "src": props2.src,
  ...
  const Switch = vue.defineComponent({
    ...
    setup(props2, {
      ...
      const checkedRef = vue.ref(props2.checked);
      return () => vue.createVNode("div", null, [vue.createVNode("input", {
        "type": "checkbox",
  ...
  const Upload = vue.defineComponent({
    ...
    setup() {
      ...
      return () => vue.createVNode("div", {
        ...
        "for": "my-file",
        "class": "upload-label"
      }, [vue.createTextVNode("\u4E0A\u4F20\u6587\u4EF6")]), vue.createVNode("input", {
        "id": "my-file",
        "type": "file",
        "class": "inputFile",
        "ref": fileInputRef,
  ...
  const NumberInput = vue.defineComponent({
    ...
    setup(props2, {
      ...
      const value = vue.ref(props2.modelValue);
