...
// node_modules/.pnpm/@antfu+install-pkg@0.1.0/node_modules/@antfu/install-pkg/dist/index.mjs
...
async function detectPackageManager(cwd = process.cwd()) {
  ...
  const agent = result ? LOCKS[import_path4.default.basename(result)] : null;
  return agent;
}
...
async function loadCollectionFromFS(name, autoInstall = false) {
  ...
  async function task() {
    ...
    let stat;
    try {
      stat = jsonPath ? await import_fs4.promises.lstat(jsonPath) : void 0;
    } catch (err) {
      return void 0;
    }
    if (stat && stat.isFile()) {
      return JSON.parse(await import_fs4.promises.readFile(jsonPath, "utf8"));
    } else {
      return void 0;
    }
  }
...
//# sourceMappingURL=node-loader-IMMHC6F7.js.map
