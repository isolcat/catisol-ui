import {
  ...
  require_process,
  require_url
} from "./chunk-TYY5EI3C.js";
import {
  $fetch
} from "./chunk-36SABB4I.js";
import {
  __commonJS,
  __export,
  __privateAdd,
...
var require_get_icon = __commonJS({
  "node_modules/.pnpm/@iconify+utils@1.0.33/node_modules/@iconify/utils/lib/icon-set/get-icon.cjs"(exports) {
    ...
    function getIconData2(data, name41, full = false) {
...
var require_shared = __commonJS({
  "node_modules/.pnpm/local-pkg@0.4.2/node_modules/local-pkg/dist/shared.cjs"(exports, module) {
    "use strict";
    ...
    async function findUpMultiple(name41, options = {}) {
      ...
      const paths = [name41].flat();
      const runMatcher = async (locateOptions) => {
        if (typeof name41 !== "function") {
          return locatePath(paths, locateOptions);
        }
        const foundPath = await name41(locateOptions.cwd);
    ...
    async function findUp(name41, options = {}) {
      const matches = await findUpMultiple(name41, { ...options, limit: 1 });
      return matches[0];
    }
    ...
    async function isPackageListed(name41, cwd) {
      const pkg = await loadPackageJSON(cwd) || {};
      return name41 in (pkg.dependencies || {}) || name41 in (pkg.devDependencies || {});
    }
  }
});
...
var require_local_pkg = __commonJS({
  "node_modules/.pnpm/local-pkg@0.4.2/node_modules/local-pkg/index.cjs"(exports, module) {
    ...
    function resolveModule(name41, options) {
      try {
        return __require.resolve(name41, options);
      } catch (e2) {
        return void 0;
      }
    }
    ...
    function isPackageExists(name41, options) {
      return !!resolvePackage(name41, options);
    }
    function getPackageJsonPath(name41, options) {
      const entry = resolvePackage(name41, options);
      if (!entry)
        return;
      return searchPackageJSON(entry);
    }
    async function getPackageInfo(name41, options) {
      const packageJsonPath = getPackageJsonPath(name41, options);
      if (!packageJsonPath)
        return;
    ...
    function getPackageInfoSync(name41, options) {
      const packageJsonPath = getPackageJsonPath(name41, options);
      if (!packageJsonPath)
        return;
    ...
    function resolvePackage(name41, options = {}) {
      try {
        return __require.resolve(`${name41}/package.json`, options);
      } catch {
      }
      try {
        return __require.resolve(name41, options);
...
// node_modules/.pnpm/@antfu+install-pkg@0.1.0/node_modules/@antfu/install-pkg/dist/index.js
var require_dist = __commonJS({
  "node_modules/.pnpm/@antfu+install-pkg@0.1.0/node_modules/@antfu/install-pkg/dist/index.js"(exports) {
    var __create = Object.create;
    var __defProp = Object.defineProperty;
    var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
    var __getOwnPropNames = Object.getOwnPropertyNames;
...
var require_dist2 = __commonJS({
  "node_modules/.pnpm/@antfu+utils@0.5.2/node_modules/@antfu/utils/dist/index.cjs"(exports) {
    ...
    var isObject3 = (val) => toString(val) === "[object Object]";
    ...
    function hasOwnProperty6(obj, v) {
      if (obj == null)
        return false;
    ...
    exports.hasOwnProperty = hasOwnProperty6;
...
var require_install_pkg = __commonJS({
  "node_modules/.pnpm/@iconify+utils@1.0.33/node_modules/@iconify/utils/lib/loader/install-pkg.cjs"(exports) {
    ...
    var pending;
    var tasks = {};
    async function tryInstallPkg(name41) {
      if (pending) {
        await pending;
      }
      if (!tasks[name41]) {
        console.log(kolorist.cyan(`Installing ${name41}...`));
        tasks[name41] = pending = installPkg.installPackage(name41, {
          dev: true,
          preferOffline: true
        }).then(() => utils.sleep(300)).catch((e2) => {
          loader_warn.warnOnce(`Failed to install ${name41}`);
          console.error(e2);
        }).finally(() => {
          pending = void 0;
        });
...
var require_fs2 = __commonJS({
  "node_modules/.pnpm/@iconify+utils@1.0.33/node_modules/@iconify/utils/lib/loader/fs.cjs"(exports) {
    ...
    async function loadCollectionFromFS(name41, autoInstall = false) {
      if (!await _collections[name41]) {
        _collections[name41] = task();
      }
      return _collections[name41];
      async function task() {
        let jsonPath = localPkg.resolveModule(`@iconify-json/${name41}/icons.json`);
        if (!jsonPath && isLegacyExists) {
          jsonPath = localPkg.resolveModule(`@iconify/json/json/${name41}.json`);
        }
        if (!jsonPath && !isLegacyExists && autoInstall) {
          await loader_installPkg.tryInstallPkg(`@iconify-json/${name41}`);
          jsonPath = localPkg.resolveModule(`@iconify-json/${name41}/icons.json`);
        }
        let stat;
        try {
  ...
  "node_modules/.pnpm/@iconify+utils@1.0.33/node_modules/@iconify/utils/lib/loader/custom.cjs"(exports) {
    ...
    async function getCustomIcon2(custom, collection, icon, options) {
      ...
      if (result) {
        ...
        return await loader_utils.mergeIconProps(((_b = options == null ? void 0 : options.customizations) == null ? void 0 : _b.trimCustomSvg) === true ? svg_trim.trimSVG(result) : result, collection, icon, options, void 0);
      }
    }
...
function mergeSet(target, append2) {
  append2.forEach((i) => target.add(i));
  return target;
}
function isString(s) {
...
var UnoGenerator = class {
    ...
    const getLayer = (layer) => {
      ...
      let css = Array.from(sheet).sort((a, b) => {
        ...
        const sorted = items.filter((i) => {
          ...
          return [
            [[scopedSelector != null ? scopedSelector : "", (_a = meta == null ? void 0 : meta.sort) != null ? _a : 0]],
            body,
  ...
  applyVariants(parsed, variantHandlers = parsed[4], raw = parsed[1]) {
    const handler2 = [...variantHandlers].sort((a, b) => (a.order || 0) - (b.order || 0)).reverse().reduce(
      (previous, v) => (input) => {
        ...
        return ((_b = v.handle) != null ? _b : defaultVariantHandler)({
          ...input,
          entries,
  ...
  async parseUtil(input, context, internal = false) {
    ...
    const recordRule = this.config.details ? (r) => {
      var _a2;
      context.rules = (_a2 = context.rules) != null ? _a2 : [];
  ...
  stringifyUtil(parsed, context) {
    ...
    if (!body)
      return;
    const { layer: metaLayer, sort: metaSort, ...meta } = (_a = parsed[3]) != null ? _a : {};
    const ruleMeta = {
      ...meta,
  ...
  expandShortcut(input, context, depth = 5) {
    ...
    const recordShortcut = this.config.details ? (s) => {
      var _a2;
      context.shortcuts = (_a2 = context.shortcuts) != null ? _a2 : [];
...
function directionSize(propertyPrefix) {
  return ([_, direction, size], { theme: theme3 }) => {
    var _a, _b;
    const v = (_b = (_a = theme3.spacing) == null ? void 0 : _a[size || "DEFAULT"]) != null ? _b : handler.bracket.cssvar.global.auto.fraction.rem(size);
    if (v != null)
...
function parseColor$1(body, theme3) {
  ...
  if (!color) {
    ...
    if (scale.match(/^\d+$/)) {
      ...
      if (!colorData && colors2.length <= 2) {
        [, no = no] = colors2;
        colorData = getThemeColor(theme3, [name41]);
      }
  ...
  return {
    ...
    alpha: handler.bracket.cssvar.percent(opacity2 != null ? opacity2 : "")
  };
}
...
function makeGlobalStaticRules(prefix, property2) {
  return globalKeywords.map((keyword2) => [`${prefix}-${keyword2}`, { [property2 != null ? property2 : prefix]: keyword2 }]);
}
...
function colorOpacityToString(color) {
  var _a;
  const alpha = (_a = color.alpha) != null ? _a : 1;
...
var outline = [
  [/^outline-(?:width-|size-)?(.+)$/, ([, d], { theme: theme3 }) => {
    var _a, _b;
    return { "outline-width": (_b = (_a = theme3.lineWidth) == null ? void 0 : _a[d]) != null ? _b : handler.bracket.cssvar.global.px(d) };
  ...
  [/^outline-offset-(.+)$/, ([, d], { theme: theme3 }) => {
    var _a, _b;
    return { "outline-offset": (_b = (_a = theme3.lineWidth) == null ? void 0 : _a[d]) != null ? _b : handler.bracket.cssvar.global.px(d) };
...
var willChangeProperty = (prop) => {
  var _a;
  return (_a = handler.properties.auto.global(prop)) != null ? _a : {
    contents: "contents",
...
function handlerBorderSize([, a = "", b], { theme: theme3 }) {
  var _a, _b;
  const v = (_b = (_a = theme3.lineWidth) == null ? void 0 : _a[b || "DEFAULT"]) != null ? _b : handler.bracket.cssvar.global.px(b || "1");
...
var transitionProperty = (prop) => {
  var _a;
  return (_a = handler.properties(prop)) != null ? _a : transitionPropertyGroup[prop];
};
var transitions = [
  [/^transition(?:-([a-z-]+(?:,[a-z-]+)*))?(?:-(\d+))?$/, ([, prop, d], { theme: theme3 }) => {
    ...
    if (p) {
      const duration2 = (_b = (_a = theme3.duration) == null ? void 0 : _a[d || "DEFAULT"]) != null ? _b : handler.time(d || "150");
      return {
  ...
  [
    ...
    ([, d], { theme: theme3 }) => {
      var _a, _b;
      return { "transition-duration": (_b = (_a = theme3.duration) == null ? void 0 : _a[d || "DEFAULT"]) != null ? _b : handler.bracket.cssvar.time(d) };
    },
  ...
  [
    ...
    ([, d], { theme: theme3 }) => {
      var _a, _b;
      return { "transition-delay": (_b = (_a = theme3.duration) == null ? void 0 : _a[d || "DEFAULT"]) != null ? _b : handler.bracket.cssvar.time(d) };
    },
  ...
  [
    ...
    ([, d], { theme: theme3 }) => {
      var _a, _b;
      return { "transition-timing-function": (_b = (_a = theme3.easing) == null ? void 0 : _a[d || "DEFAULT"]) != null ? _b : handler.bracket.cssvar(d) };
    },
...
var fonts = [
  ...
  [/^text-size-(.+)$/, ([, s], { theme: theme3 }) => {
    var _a, _b;
    const themed = toArray((_a = theme3.fontSize) == null ? void 0 : _a[s]);
    const size = (_b = themed == null ? void 0 : themed[0]) != null ? _b : handler.bracket.cssvar.global.rem(s);
    if (size != null)
...
function handleInsetValue(v, { theme: theme3 }) {
  var _a, _b;
  return (_b = (_a = theme3.spacing) == null ? void 0 : _a[v]) != null ? _b : handler.bracket.cssvar.global.auto.fraction.rem(v);
}
...
var rings = [
  [/^ring(?:-(.+))?$/, ([, d], { theme: theme3 }) => {
    var _a, _b;
    const value = (_b = (_a = theme3.ringWidth) == null ? void 0 : _a[d || "DEFAULT"]) != null ? _b : handler.px(d || "1");
    if (value) {
      return {
        "--un-ring-width": value,
  ...
  [/^ring-(?:width-|size-)(.+)$/, ([, d], { theme: theme3 }) => {
    var _a, _b;
    return { "--un-ring-width": (_b = (_a = theme3.lineWidth) == null ? void 0 : _a[d]) != null ? _b : handler.bracket.cssvar.px(d) };
  }, { autocomplete: "ring-(width|size)-$lineWidth" }],
  ["ring-offset", { "--un-ring-offset-width": "1px" }],
  [/^ring-offset-(?:width-|size-)?(.+)$/, ([, d], { theme: theme3 }) => {
    var _a, _b;
    return { "--un-ring-offset-width": (_b = (_a = theme3.lineWidth) == null ? void 0 : _a[d]) != null ? _b : handler.bracket.cssvar.px(d) };
...
var transforms = [
  [/^(?:transform-)?origin-(.+)$/, ([, s]) => {
    var _a;
    return { "transform-origin": (_a = positionMap[s]) != null ? _a : handler.bracket.cssvar(s) };
  ...
  [/^(?:transform-)?perspect(?:ive)?-origin-(.+)$/, ([, s]) => {
    var _a;
    const v = (_a = handler.bracket.cssvar(s)) != null ? _a : s.length >= 3 ? positionMap[s] : void 0;
    if (v != null) {
      return {
...
function handleTranslate([, d, b], { theme: theme3 }) {
  var _a, _b;
  const v = (_b = (_a = theme3.spacing) == null ? void 0 : _a[b]) != null ? _b : handler.bracket.cssvar.fraction.rem(b);
  if (v != null) {
    return [
...
var textDecorations = [
  ...
  [/^(?:underline|decoration)-(?:size-)?(.+)$/, ([, s], { theme: theme3 }) => {
    var _a, _b;
    return { "text-decoration-thickness": (_b = (_a = theme3.lineWidth) == null ? void 0 : _a[s]) != null ? _b : handler.bracket.cssvar.global.px(s) };
  ...
  [/^(?:underline|decoration)-offset-(.+)$/, ([, s], { theme: theme3 }) => {
    var _a, _b;
    return { "text-underline-offset": (_b = (_a = theme3.lineWidth) == null ? void 0 : _a[s]) != null ? _b : handler.auto.bracket.cssvar.global.px(s) };
...
var flex = [
  ...
  [/^flex-(.*)$/, ([, d]) => ({ flex: handler.bracket(d) != null ? handler.bracket(d).split(" ").map((e2) => {
    var _a;
    return (_a = handler.cssvar.fraction(e2)) != null ? _a : e2;
  }).join(" ") : handler.cssvar.fraction(d) })],
  ["flex-1", { flex: "1 1 0%" }],
  ...
  [/^(?:flex-)?shrink(?:-(.*))?$/, ([, d = ""]) => {
    var _a;
    return { "flex-shrink": (_a = handler.bracket.cssvar.number(d)) != null ? _a : 1 };
  }, { autocomplete: ["flex-shrink-<num>", "shrink-<num>"] }],
  [/^(?:flex-)?grow(?:-(.*))?$/, ([, d = ""]) => {
    var _a;
    return { "flex-grow": (_a = handler.bracket.cssvar.number(d)) != null ? _a : 1 };
  }, { autocomplete: ["flex-grow-<num>", "grow-<num>"] }],
  [/^(?:flex-)?basis-(.+)$/, ([, d], { theme: theme3 }) => {
    var _a, _b;
    return { "flex-basis": (_b = (_a = theme3.spacing) == null ? void 0 : _a[d]) != null ? _b : handler.bracket.cssvar.auto.fraction.rem(d) };
...
var handleGap = ([, d = "", s], { theme: theme3 }) => {
  var _a, _b;
  const v = (_b = (_a = theme3.spacing) == null ? void 0 : _a[s]) != null ? _b : handler.bracket.cssvar.global.rem(s);
  if (v != null) {
    return {
...
var grids = [
  ...
  [/^(?:grid-)?(row|col)-(.+)$/, ([, c, v], { theme: theme3 }) => {
    var _a, _b;
    return {
      [`grid-${rowCol(c)}`]: (_b = (_a = theme3[`grid${rowColTheme(c)}`]) == null ? void 0 : _a[v]) != null ? _b : handler.bracket.cssvar.auto(v)
    };
  }],
  ...
  [/^(?:grid-)?(row|col)-start-(.+)$/, ([, c, v]) => {
    var _a;
    return { [`grid-${rowCol(c)}-start`]: (_a = handler.bracket.cssvar(v)) != null ? _a : v };
  }],
  [/^(?:grid-)?(row|col)-end-(.+)$/, ([, c, v]) => {
    var _a;
    return { [`grid-${rowCol(c)}-end`]: (_a = handler.bracket.cssvar(v)) != null ? _a : v };
  ...
  [/^grid-(rows|cols)-(.+)$/, ([, c, v], { theme: theme3 }) => {
    var _a, _b;
    return {
      [`grid-template-${rowCol(c)}`]: (_b = (_a = theme3[`gridTemplate${rowColTheme(c)}`]) == null ? void 0 : _a[v]) != null ? _b : handler.bracket.cssvar(v)
    };
  }],
...
var cssVariables = [
  [/^(.+?)-(\$.+)$/, ([, name41, varname]) => {
    const prop = variablesAbbrMap[name41];
    if (prop)
...
var svgUtilities = [
  ...
  [/^stroke-(?:width-|size-)?(.+)$/, ([, s], { theme: theme3 }) => {
    var _a, _b;
    return { "stroke-width": (_b = (_a = theme3.lineWidth) == null ? void 0 : _a[s]) != null ? _b : handler.bracket.cssvar.fraction.px.number(s) };
  ...
  [/^stroke-offset-(.+)$/, ([, s], { theme: theme3 }) => {
    var _a, _b;
    return { "stroke-dashoffset": (_b = (_a = theme3.lineWidth) == null ? void 0 : _a[s]) != null ? _b : handler.bracket.cssvar.px.numberWithUnit(s) };
...
var variantMatcher = (name41, handler2) => {
  const re = new RegExp(`^${escapeRegExp(name41)}[:-]`);
  return {
    name: name41,
    match: (input) => {
...
var variantParentMatcher = (name41, parent) => {
  const re = new RegExp(`^${escapeRegExp(name41)}[:-]`);
  return {
    name: name41,
    match: (input) => {
...
var variantBreakpoints = {
  ...
  match(matcher, context) {
    var _a;
    const variantEntries = Object.entries((_a = resolveBreakpoints(context)) != null ? _a : {}).map(([point, size], idx) => [point, size, idx]);
...
var scopeMatcher = (strict, name41, template) => {
  const re = strict ? new RegExp(`^${name41}(?:-\\[(.+?)\\])[:-]`) : new RegExp(`^${name41}(?:-\\[(.+?)\\])?[:-]`);
  return {
    name: `combinator:${name41}`,
    match: (matcher) => {
      ...
      if (match) {
        return {
          ...
          selector: (s) => {
            var _a;
            return template.replace("&&-s", s).replace("&&-c", (_a = match[1]) != null ? _a : "*");
          }
        };
      }
    },
...
var variantCustomMedia = {
  ...
  match(matcher, { theme: theme3 }) {
    ...
    if (match) {
      const media = (_b = (_a = theme3.media) == null ? void 0 : _a[match[1]]) != null ? _b : `(--${match[1]})`;
      return {
        matcher: matcher.slice(match[0].length),
        handle: (input, next) => next({
          ...input,
...
var variantVariables = {
  ...
  match(matcher) {
    ...
    if (!matcher.startsWith("["))
      return;
    const [match, rest] = (_a = getComponent(matcher, "[", "]", ":")) != null ? _a : [];
    if (!(match && rest && rest !== ""))
      return;
    const variant = (_b = handler.bracket(match)) != null ? _b : "";
...
var presetMini = (options = {}) => {
  var _a, _b;
  options.dark = (_a = options.dark) != null ? _a : "class";
  options.attributifyPseudo = (_b = options.attributifyPseudo) != null ? _b : false;
  return {
...
var animations = [
  [/^(?:animate-)?keyframes-(.+)$/, ([, name41], { theme: theme3 }) => {
    var _a, _b;
    const kf = (_b = (_a = theme3.animation) == null ? void 0 : _a.keyframes) == null ? void 0 : _b[name41];
    if (kf) {
      return [
        `@keyframes ${name41}${kf}`,
        { animation: name41 }
  ...
  [/^animate-(.+)$/, ([, name41], { theme: theme3 }) => {
    var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m;
    const kf = (_b = (_a = theme3.animation) == null ? void 0 : _a.keyframes) == null ? void 0 : _b[name41];
    if (kf) {
      const duration2 = (_e = (_d = (_c = theme3.animation) == null ? void 0 : _c.durations) == null ? void 0 : _d[name41]) != null ? _e : "1s";
      const timing = (_h = (_g = (_f = theme3.animation) == null ? void 0 : _f.timingFns) == null ? void 0 : _g[name41]) != null ? _h : "linear";
      const count = (_k = (_j = (_i = theme3.animation) == null ? void 0 : _i.counts) == null ? void 0 : _j[name41]) != null ? _k : 1;
      const props = (_m = (_l = theme3.animation) == null ? void 0 : _l.properties) == null ? void 0 : _m[name41];
      return [
        `@keyframes ${name41}${kf}`,
        {
          animation: `${name41} ${duration2} ${timing} ${count}`,
          ...props
        }
      ];
    }
    return { animation: handler.bracket.cssvar(name41) };
  }, { autocomplete: "animate-$animation.keyframes" }],
  [/^animate-name-(.+)/, ([, d]) => {
    var _a;
    return { "animation-name": (_a = handler.bracket.cssvar(d)) != null ? _a : d };
  }],
  [/^animate-duration-(.+)$/, ([, d], { theme: theme3 }) => {
    var _a, _b;
    return { "animation-duration": (_b = (_a = theme3.duration) == null ? void 0 : _a[d || "DEFAULT"]) != null ? _b : handler.bracket.cssvar.time(d) };
  }, { autocomplete: ["animate-duration", "animate-duration-$duration"] }],
  [/^animate-delay-(.+)$/, ([, d], { theme: theme3 }) => {
    var _a, _b;
    return { "animation-delay": (_b = (_a = theme3.duration) == null ? void 0 : _a[d || "DEFAULT"]) != null ? _b : handler.bracket.cssvar.time(d) };
  }, { autocomplete: ["animate-delay", "animate-delay-$duration"] }],
  [/^animate-ease(?:-(.+))?$/, ([, d], { theme: theme3 }) => {
    var _a, _b;
    return { "animation-timing-function": (_b = (_a = theme3.easing) == null ? void 0 : _a[d || "DEFAULT"]) != null ? _b : handler.bracket.cssvar(d) };
  ...
  [/^animate-(?:iteration-|count-|iteration-count-)(.+)$/, ([, d]) => {
    var _a;
    return { "animation-iteration-count": (_a = handler.bracket.cssvar(d)) != null ? _a : d.replace(/\-/g, ",") };
...
var containerShortcuts = [
  [/^(?:(\w+)[:-])?container$/, ([, bp], context) => {
    var _a;
    let points = Object.keys((_a = resolveBreakpoints(context)) != null ? _a : {});
    if (bp) {
...
var toFilter = (varName, resolver) => ([, b, s], { theme: theme3 }) => {
  var _a;
  const value = (_a = resolver(s, theme3)) != null ? _a : s === "none" ? "0" : "";
  if (value !== "") {
    if (b) {
      return {
...
function handlerSpace([, d, s], { theme: theme3 }) {
  var _a, _b;
  const v = (_b = (_a = theme3.spacing) == null ? void 0 : _a[s || "DEFAULT"]) != null ? _b : handler.bracket.cssvar.auto.fraction.rem(s || "1");
  if (v != null) {
...
var tables = [
  ...
  [/^border-spacing-(.+)$/, ([, s], { theme: theme3 }) => {
    var _a, _b;
    const v = (_b = (_a = theme3.spacing) == null ? void 0 : _a[s]) != null ? _b : handler.bracket.cssvar.global.auto.fraction.rem(s);
    if (v != null) {
      return {
...
var cssVariables2 = [
  [/^(.+?)-(\$.+)$/, ([, name41, varname]) => {
    const prop = variablesAbbrMap2[name41];
    if (prop)
      return { [prop]: handler.cssvar(varname) };
  }]
];
...
function handlerDivide([, d, s], { theme: theme3 }) {
  var _a, _b;
  const v = (_b = (_a = theme3.lineWidth) == null ? void 0 : _a[s || "DEFAULT"]) != null ? _b : handler.bracket.cssvar.px(s || "1");
  if (v != null) {
    const results = directionMap[d].map((item) => {
...
var mixColor = (color1, color2, weight) => {
  ...
  return {
    ...
    alpha: mixComponent((_a = cssColors[0].alpha) != null ? _a : 1, (_b = cssColors[1].alpha) != null ? _b : 1, weight)
  };
};
...
var variantAttributify = (options = {}) => {
  ...
  const prefixedOnly = (_b = options.prefixedOnly) != null ? _b : false;
...
var extractorAttributify = (options) => {
  var _a, _b, _c;
  const ignoreAttributes = (_a = options == null ? void 0 : options.ignoreAttributes) != null ? _a : defaultIgnoreAttributes;
...
var preset = (options = {}) => {
  var _a, _b, _c, _d, _e;
  options.strict = (_a = options.strict) != null ? _a : false;
  options.prefix = (_b = options.prefix) != null ? _b : "un-";
...
var variantTagify = (options) => {
  ...
  const prefix = `${MARKER}${(_a = options.prefix) != null ? _a : ""}`;
  return {
    name: "tagify",
    match(input) {
      ...
      if (extraProperties) {
        if (typeof extraProperties === "function")
          handler2.body = (entries) => {
            var _a2;
            return [...entries, ...Object.entries((_a2 = extraProperties(matcher)) != null ? _a2 : {})];
          };
        else
...
function getIconData(data, name41, full = false) {
  function getIcon(name210, iteration) {
    if (data.icons[name210] !== void 0) {
      return Object.assign({}, data.icons[name210]);
    }
...
function add(keyword2, colors2) {
  ...
  ({
    type,
    r,
    g: length > 1 ? colors2[1] : r,
    b: length > 2 ? colors2[2] : r,
...
async function getCustomIcon(custom, collection, icon, options) {
  ...
  if (result) {
    ...
    return await mergeIconProps(((_b = options == null ? void 0 : options.customizations) == null ? void 0 : _b.trimCustomSvg) === true ? trimSVG(result) : result, collection, icon, options, void 0);
  }
}
...
function createCDNLoader(cdnBase) {
  ...
  function fetchCollection(name41) {
    if (!supportedCollection.includes(name41))
      return void 0;
    if (!cache.has(name41))
      cache.set(name41, $fetch(`${cdnBase}@iconify-json/${name41}/icons.json`));
    return cache.get(name41);
  }
    ...
    return {
      ...
      rules: [[
        ...
        async ([full, body, _mode = mode]) => {
          ...
          const usedProps = {};
          if (body.includes(":")) {
            [collection, name41] = body.split(":");
            svg = await iconLoader(collection, name41, { ...loaderOptions, usedProps });
          } else {
            const parts = body.split(/-/g);
            for (let i = COLLECTION_NAME_PARTS_MAX; i >= 1; i--) {
              collection = parts.slice(0, i).join("-");
              name41 = parts.slice(i).join("-");
              svg = await iconLoader(collection, name41, { ...loaderOptions, usedProps });
              if (svg)
                break;
            }
...
async function createNodeLoader() {
  try {
    return await import("./node-loader-IMMHC6F7.js").then((i) => i == null ? void 0 : i.loadNodeIcon);
  } catch {
  }
  try {
...
function createGoogleProvider(name41, host) {
  return {
    name: name41,
    getImportUrl(fonts2) {
      const strings = fonts2.filter((i) => i.provider === name41).map((i) => {
        var _a;
...
function normalizedFontMeta(meta, defaultProvider) {
  ...
  if (typeof meta !== "string") {
    meta.provider = (_a = meta.provider) != null ? _a : defaultProvider;
    return meta;
  }
  const [name41, weights = ""] = meta.split(":");
  return {
    name: name41,
...
var preset2 = (options = {}) => {
  ...
  const fontObject = Object.fromEntries(
    Object.entries(options.fonts || {}).map(([name41, meta]) => [name41, toArray(meta).map((m) => normalizedFontMeta(m, defaultProvider))])
  );
  ...
  async function importUrl(url) {
    if (inlineImports) {
      if (!importCache[url]) {
        const { $fetch: $fetch2 } = await import("./dist-ZXYLVE3G.js");
    ...
    preflights: [
      {
        async getCSS() {
          ...
          const preflights2 = [];
          for (const name41 of names) {
            const fontsForProvider = fonts2.filter((i) => i.provider === name41);
            const provider = providers[name41];
  ...
  if (extendTheme) {
    preset22.extendTheme = (theme3) => {
      ...
      const obj = Object.fromEntries(
        Object.entries(fontObject).map(([name41, fonts22]) => [name41, fonts22.map((f) => providers[f.provider || defaultProvider].getFontName(f))])
      );
    ...
    rules: [
      ...
      [
        ...
        ([, color], { theme: theme3 }) => {
          ...
          return {
            "--un-prose-body": (_b = colorObject[700]) != null ? _b : baseColor,
            "--un-prose-headings": (_c = colorObject[900]) != null ? _c : baseColor,
            "--un-prose-links": (_d = colorObject[900]) != null ? _d : baseColor,
            "--un-prose-lists": (_e = colorObject[400]) != null ? _e : baseColor,
            "--un-prose-hr": (_f = colorObject[200]) != null ? _f : baseColor,
            "--un-prose-captions": (_g = colorObject[500]) != null ? _g : baseColor,
            "--un-prose-code": (_h = colorObject[900]) != null ? _h : baseColor,
            "--un-prose-borders": (_i = colorObject[200]) != null ? _i : baseColor,
            "--un-prose-bg-soft": (_j = colorObject[100]) != null ? _j : baseColor,
            "--un-prose-invert-body": (_k = colorObject[200]) != null ? _k : baseColor,
            "--un-prose-invert-headings": (_l = colorObject[100]) != null ? _l : baseColor,
            "--un-prose-invert-links": (_m = colorObject[100]) != null ? _m : baseColor,
            "--un-prose-invert-lists": (_n = colorObject[500]) != null ? _n : baseColor,
            "--un-prose-invert-hr": (_o = colorObject[700]) != null ? _o : baseColor,
            "--un-prose-invert-captions": (_p = colorObject[400]) != null ? _p : baseColor,
            "--un-prose-invert-code": (_q = colorObject[100]) != null ? _q : baseColor,
            "--un-prose-invert-borders": (_r = colorObject[700]) != null ? _r : baseColor,
            "--un-prose-invert-bg-soft": (_s = colorObject[800]) != null ? _s : baseColor,
            "--un-prose-font-mono": (_t = theme3.fontFamily) == null ? void 0 : _t.mono
          };
        },
        { layer: "typography" }
      ],
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/tokenizer/types.js
var types_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/tokenizer/char-code-definitions.js
var EOF2 = 0;
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/tokenizer/utils.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/tokenizer/names.js
var names_default = [
  "EOF-token",
  "ident-token",
  "function-token",
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/tokenizer/adopt-buffer.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/tokenizer/OffsetToLocation.js
var N = 10;
var F = 12;
var R = 13;
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/tokenizer/TokenStream.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/tokenizer/index.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/utils/List.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/utils/create-custom-error.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/parser/SyntaxError.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/parser/sequence.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/parser/create.js
var NOOP = () => {
};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/generator/sourceMap.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/generator/token-before.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/generator/create.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/convertor/create.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/walker/create.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/definition-syntax/generate.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/lexer/error.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/utils/names.js
...
function getPropertyDescriptor(property2) {
  ...
  if (!custom) {
    ...
    if (properties2.has(name41)) {
      const descriptor2 = properties2.get(name41);
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/lexer/generic-const.js
var cssWideKeywords = [
  "initial",
  "inherit",
  "unset",
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/lexer/generic-an-plus-b.js
var PLUSSIGN2 = 43;
var HYPHENMINUS3 = 45;
var N2 = 110;
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/lexer/generic-urange.js
var PLUSSIGN3 = 43;
var HYPHENMINUS4 = 45;
var QUESTIONMARK = 63;
var U = 117;
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/lexer/generic.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/definition-syntax/index.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/definition-syntax/SyntaxError.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/definition-syntax/tokenizer.js
var TAB = 9;
var N3 = 10;
var F2 = 12;
var R2 = 13;
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/definition-syntax/parse.js
var TAB2 = 9;
var N4 = 10;
var F3 = 12;
var R3 = 13;
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/definition-syntax/walk.js
var noop4 = function() {
};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/lexer/prepare-tokens.js
var astToTokens = {
  decorator(handlers) {
    const tokens = [];
    let curNode = null;
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/lexer/match-graph.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/lexer/match.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/lexer/trace.js
var trace_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/lexer/search.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/lexer/structure.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/lexer/Lexer.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/config/mix.js
...
function appendOrAssignOrNull(a, b) {
  ...
  return !isObject2(result) || Object.keys(result).length ? result : null;
}
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/create.js
function createSyntax(config) {
  const parse43 = createParser(config);
  const walk3 = createWalker(config);
  const generate43 = createGenerator2(config);
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/dist/data.js
var data_default = {
  "generic": true,
  "types": {
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/index.js
var node_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/AnPlusB.js
var AnPlusB_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Atrule.js
var Atrule_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/AtrulePrelude.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/AttributeSelector.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Block.js
var Block_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Brackets.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/CDC.js
var CDC_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/CDO.js
var CDO_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/ClassSelector.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Combinator.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Comment.js
var Comment_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Declaration.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/DeclarationList.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Dimension.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Function.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Hash.js
var Hash_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Identifier.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/IdSelector.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/MediaFeature.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/MediaQuery.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/MediaQueryList.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Nth.js
var Nth_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Number.js
var Number_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Operator.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Parentheses.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Percentage.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/PseudoClassSelector.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/PseudoElementSelector.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Ratio.js
var Ratio_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Raw.js
var Raw_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Rule.js
var Rule_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Selector.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/SelectorList.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/String.js
var String_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/utils/string.js
var string_exports = {};
__export(string_exports, {
  decode: () => decode,
  encode: () => encode
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/StyleSheet.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/TypeSelector.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/UnicodeRange.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Url.js
var Url_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/utils/url.js
var url_exports = {};
__export(url_exports, {
  decode: () => decode2,
  encode: () => encode2
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/Value.js
var Value_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/WhiteSpace.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/config/lexer.js
var lexer_default = {
  generic: true,
  ...data_default,
  node: node_exports
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/scope/index.js
var scope_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/scope/default.js
var NUMBERSIGN4 = 35;
var ASTERISK6 = 42;
var PLUSSIGN9 = 43;
var HYPHENMINUS7 = 45;
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/scope/atrulePrelude.js
var atrulePrelude_default = {
  getNode: defaultRecognizer
};

// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/scope/selector.js
var NUMBERSIGN5 = 35;
var ASTERISK7 = 42;
var PLUSSIGN10 = 43;
var SOLIDUS6 = 47;
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/function/expression.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/function/var.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/scope/value.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/atrule/font-face.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/atrule/import.js
var import_default7 = {
  parse: {
    prelude() {
      const children = this.createList();
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/atrule/media.js
var media_default = {
  parse: {
    prelude() {
      return this.createSingleNodeList(
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/atrule/page.js
var page_default = {
  parse: {
    prelude() {
      return this.createSingleNodeList(
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/atrule/supports.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/atrule/index.js
var atrule_default = {
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/pseudo/index.js
var selectorList = {
  parse() {
    return this.createSingleNodeList(
      this.SelectorList()
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/node/index-parse.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/config/parser.js
var parser_default = {
  parseContext: {
    default: "StyleSheet",
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/config/walker.js
var walker_default = {
  node: node_exports
};

// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/syntax/index.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/utils/clone.js
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/utils/ident.js
var ident_exports = {};
...
// node_modules/.pnpm/css-tree@2.2.1/node_modules/css-tree/lib/index.js
var {
  tokenize: tokenize2,
  parse: parse42,
  generate: generate42,
...
async function transformDirectives(code2, uno, options, filename, originalCode, offset) {
  ...
  if (!isApply && !hasThemeFn)
    return;
  const ast = parse42(originalCode || code2.original, {
  ...
  const handleApply = async (node, childNode) => {
    ...
    )).filter(notNull).flat().sort((a, b) => a[0] - b[0]).sort((a, b) => {
      var _a, _b;
      return (a[3] ? (_a = uno.parentOrders.get(a[3])) != null ? _a : 0 : 0) - (b[3] ? (_b = uno.parentOrders.get(b[3])) != null ? _b : 0 : 0);
    }).reduce((acc, item) => {
    ...
    for (const i of utils) {
      ...
      if (parent || selector2 && selector2 !== ".\\-") {
        let newSelector = generate42(node.prelude);
        if (selector2 && selector2 !== ".\\-") {
          const selectorAST = parse42(selector2, {
            context: "selector"
          });
          ...
          newSelector = generate42(prelude);
        }
